...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $name = $_POST['name'];
    $sql = "SELECT * FROM type WHERE name = '$name' AND company = '" . $_SESSION['company'] . "'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql = "INSERT INTO type (name, company) VALUES ('$name', '" . $_SESSION['company'] . "')";
        if (mysqli_query($conn, $sql)) {
            $message = "Type name inserted successfully!";
        } else {
